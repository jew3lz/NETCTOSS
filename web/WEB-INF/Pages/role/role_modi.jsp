...
<div id="main">
	...
	<form:form commandName="role" action="/NETCTOSS/role/${role.role_id}" method="put" cssClass="main_form">
		<div class="text_info clearfix"><span>角色名称：</span></div>
		<div class="input_info">
			<form:input type="text" cssClass="width200"  path="name"/>
		...
		<div class="input_info_high">
			<div class="input_info_scroll">
				<ul>
					...
					<li><form:checkbox path="priIds" value="${p.id}" label="${p.name}"/></li>
					</c:forEach>
				</ul>
			</div>
			<span class="required">*</span>
